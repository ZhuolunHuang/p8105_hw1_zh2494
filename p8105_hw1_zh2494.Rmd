...
**The mean of the character is `r mean_char`,taking the mean does not work and will return NA instead.**
**The mean of the numeric number is `r mean_factor`,taking the mean does not work and will return NA instead.**
