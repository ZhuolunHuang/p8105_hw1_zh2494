...
```
    ...
    ##  1      1.29   TRUE        a        high      
    ##  2      1.16   TRUE        b        low       
    ##  3     -0.0385 FALSE       c        median    
    ##  4      2.34   TRUE        d        high      
    ##  5      0.338  TRUE        e        low       
    ##  6     -0.801  FALSE       f        median    
    ##  7      0.0990 TRUE        g        high      
    ##  8     -0.129  FALSE       h        low       
    ##  9      0.601  TRUE        I        median    
    ## 10     -1.74   FALSE       g        high
...
The mean of the numeric number is 0.3114265 The mean of the numeric
